...
export function ChatBubble({ message, show }: ChatBubbleProps) {
  ...
  return (
    <div className="flex flex-col items-start gap-0.75">
      {/* Bubble */}
      <div
        className="bg-[#1c2333] border-2 border-[#1a5f80] px-2 py-2.5 text-md text-[#c9d1d9] leading-relaxed border-l-3 border-l-[#2a9fd6] h-25 w-full overflow-scroll animate-scale-up-center"
        style={{
          clipPath:
