// Contacts.tsx
// Preserves all original animations via Tailwind + inline CSS custom properties.
// No extra packages needed — the fill-from-bottom and tooltip transitions
// are handled with Tailwind's `group` utilities and CSS variables for per-social colors.
...
export const Contacts: FC = () => {
  ...
  return (
    <ul className="absolute flex items-end justify-center gap-2 list-none mt-2 p-0 right-1 w-37">
        ...
        return (
          <li
            ...
            <a
              ...
              target="_blank"
              className={cn(
                'relative overflow-hidden flex items-center justify-center w-8 h-8 rounded-full bg-white text-[#4d4d4d] transition-[color,box-shadow] duration-300 ease-in-out hover:text-white hover:shadow-[3px_2px_45px_0px_rgb(0_0_0/12%)]',
                isActive && 'text-white',
              )}>
